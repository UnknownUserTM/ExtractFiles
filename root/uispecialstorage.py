...
class SpecialStorageWindow(ui.ScriptWindow):
	...
	WINDOW_NAMES = {
		UPGRADE_TYPE	:	"UppItem-Lager",
		BOOK_TYPE	:	"Fertigkeitsbuch-Lager",
		STONE_TYPE	:	"Geiststein-Lager"
	}
	...
	def __LoadWindow(self):
		...
		try:
			...
			pyScrLoader.LoadScriptFile(self, "exscript/SpecialStorageWindow.py")
		except:
			import exception
		...
		try:
			...
			self.titleName = self.GetChild("titleTextLine")
			self.inventoryTab = []
