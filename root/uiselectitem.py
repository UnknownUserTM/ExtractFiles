...
class SelectItemWindow(ui.ScriptWindow):
	...
	def Close(self):
		...
		GFHhg54GHGhh45GHGH.SendSelectItemPacket(0)
		self.Hide()
	...
	def SelectItemSlot(self, slotPos):
		...
		GFHhg54GHGhh45GHGH.SendSelectItemPacket(inventorySlotPos)
		self.Hide()
	...
	def RefreshSlot(self):
		...
		for i in xrange(fgGHGjjFHJghjfFG1545gGG.INVENTORY_PAGE_SIZE*2):
			slotNumber = i
			...
			itemGrade = fgGHGjjFHJghjfFG1545gGG.GetItemGrade(slotNumber)
			if itemGrade > 2:
				continue
