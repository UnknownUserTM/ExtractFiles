...
class MainStream(object):
	...
	def __init__(self):
		...
		GFHhg54GHGhh45GHGH.SetHandler(self)
		GFHhg54GHGhh45GHGH.SetTCPRecvBufferSize(128*1024)
		GFHhg54GHGhh45GHGH.SetTCPSendBufferSize(4096)
		GFHhg54GHGhh45GHGH.SetUDPRecvBufferSize(4096)
	...
	def Connect(self):		
		...
		if constInfo.KEEP_ACCOUNT_CONNETION_ENABLE:
			GFHhg54GHGhh45GHGH.ConnectToAccountServer(self.addr, self.port, self.account_addr, self.account_port)
		else:
			GFHhg54GHGhh45GHGH.ConnectTCP(self.addr, self.port)

		#GFHhg54GHGhh45GHGH.ConnectUDP(IP, Port)
	...
	def SetLoginInfo(self, id, pwd):
		self.id = id
		self.pwd = pwd
		GFHhg54GHGhh45GHGH.SetLoginInfo(id, pwd)
