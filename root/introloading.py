...
class LoadingWindow(ui.ScriptWindow):
	def __init__(self, stream):
		...
		GFHhg54GHGhh45GHGH.SetPhaseWindow(GFHhg54GHGhh45GHGH.PHASE_WINDOW_LOAD, self)
	...
	def __del__(self):
		...
		GFHhg54GHGhh45GHGH.SetPhaseWindow(GFHhg54GHGhh45GHGH.PHASE_WINDOW_LOAD, 0)
	...
	def __LoadMap(self):
		GFHhg54GHGhh45GHGH.Warp(self.playerX, self.playerY)
