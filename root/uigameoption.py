...
class OptionDialog(ui.ScriptWindow):
	...
	def __OnClickHideCostumeButton(self):
		if constInfo.HideCostume == 0:
			chat.AppendChat(chat.CHAT_TYPE_INFO, "Dein Rüstungskostüm wird nun ausgeblendet!")
	...
	def __OnClickShowCostumeButton(self):
		if constInfo.HideCostume == 1:
			chat.AppendChat(chat.CHAT_TYPE_INFO, "Dein Rüstungskostüm wird nun angezeigt!")
	...
	def __OnClickHideCostumeButton2(self):
		if constInfo.HideCostume2 == 0:
			chat.AppendChat(chat.CHAT_TYPE_INFO, "Dein Waffenkostüm wird nun ausgeblendet!")
	...
	def __OnClickShowCostumeButton2(self):
		if constInfo.HideCostume2 == 1:
			chat.AppendChat(chat.CHAT_TYPE_INFO, "Dein Waffenkostüm wird nun angezeigt!")
