...
class PlayerGauge(ui.Gauge):
	...
	def OnUpdate(self):
		playerIndex = fgGHGjjFHJghjfFG1545gGG.GetMainCharacterIndex()
	...
	def RefreshGauge(self):
		...
		self.curHP = fgGHGjjFHJghjfFG1545gGG.GetStatus(fgGHGjjFHJghjfFG1545gGG.HP)
		self.maxHP = fgGHGjjFHJghjfFG1545gGG.GetStatus(fgGHGjjFHJghjfFG1545gGG.MAX_HP)
