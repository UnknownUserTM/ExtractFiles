...
class SelectCharacterWindow(ui.Window):
	...
	#SLOT_ROTATION = [135.0, 225.0, 315.0, 45.0, 72.0]
	SLOT_COUNT = 4
	CHARACTER_TYPE_COUNT = 4

	EMPIRE_NAME = { 
		GFHhg54GHGhh45GHGH.EMPIRE_A : localeInfo.EMPIRE_A, 
		GFHhg54GHGhh45GHGH.EMPIRE_B : localeInfo.EMPIRE_B, 
		GFHhg54GHGhh45GHGH.EMPIRE_C : localeInfo.EMPIRE_C 
	}
	...
	class CharacterRenderer(ui.Window):
		def OnRender(self):
			...
			newScreenHeight = float(screenHeight - 70)
	...
	def __init__(self, stream):
		...
		GFHhg54GHGhh45GHGH.SetPhaseWindow(GFHhg54GHGhh45GHGH.PHASE_WINDOW_SELECT, self)
	...
	def __del__(self):
		...
		GFHhg54GHGhh45GHGH.SetPhaseWindow(GFHhg54GHGhh45GHGH.PHASE_WINDOW_SELECT, 0)
	...
	def Open(self):
		...
		self.HideAllFlag()
		self.SetEmpire(GFHhg54GHGhh45GHGH.GetEmpireID())
	...
	def Refresh(self):
		...
		for index in indexArray:
			id=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(index, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_ID)
			race=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(index, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_RACE)
			form=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(index, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_FORM)
			name=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataString(index, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_NAME)
			hair=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(index, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_HAIR)
	...
	def GetCharacterSlotID(self, slotIndex):
		return GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(slotIndex, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_ID)
	...
	def __LoadBoardDialog(self, fileName):
		...
		try:
			...
			self.GaugeList = []
			self.GaugeList.append(GetObject("character_hth_gauge_fill"))
			self.GaugeList.append(GetObject("character_int_gauge_fill"))
			self.GaugeList.append(GetObject("character_str_gauge_fill"))
			self.GaugeList.append(GetObject("character_dex_gauge_fill"))

			self.btnLeft = GetObject("left_button")
			self.btnRight = GetObject("right_button")

			self.empireName = GetObject("EmpireName")
			self.flagDict[GFHhg54GHGhh45GHGH.EMPIRE_A] = GetObject("EmpireFlag_A")
			self.flagDict[GFHhg54GHGhh45GHGH.EMPIRE_B] = GetObject("EmpireFlag_B")
			self.flagDict[GFHhg54GHGhh45GHGH.EMPIRE_C] = GetObject("EmpireFlag_C")
	...
	def AcceptInputName(self):
		...
		GFHhg54GHGhh45GHGH.SendChangeNamePacket(self.nameInputBoard.slot, changeName)
	...
	def __AreAllSlotEmpty(self):
		for iSlot in xrange(self.SLOT_COUNT):
			if 0!=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(iSlot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_ID):
				return 0
		return 1
	...
	def RequestDeleteCharacter(self):
		...
		GFHhg54GHGhh45GHGH.SendDestroyCharacterPacket(self.slot, "1234567")
	...
	def AcceptInputPrivateCode(self):
		...
		GFHhg54GHGhh45GHGH.SendDestroyCharacterPacket(self.slot, privateCode)
		self.PopupMessage(localeInfo.SELECT_DELEING)
	...
	def SelectSlot(self, index):
		...
		id=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_ID)
		if 0 != id:
			...
			playTime=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_PLAYTIME)
			level=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_LEVEL)
			race=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_RACE)
			valueHTH=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_HTH)
			valueINT=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_INT)
			valueSTR=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_STR)
			valueDEX=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_DEX)
			name=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataString(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_NAME)
			guildID=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_GUILD_ID)
			guildName=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataString(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_GUILD_NAME)
			self.changeNameFlag=GFHhg54GHGhh45GHGH.GetAccountCharacterSlotDataInteger(self.slot, GFHhg54GHGhh45GHGH.ACCOUNT_CHARACTER_SLOT_CHANGE_NAME_FLAG)
