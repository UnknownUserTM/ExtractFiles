...
def LoadLocaleData():
	if IsYMIR():
		...
		SERVER = "ƒËµµ º≠πˆ"
		if SERVER == GFHhg54GHGhh45GHGH.GetServerInfo()[:len(SERVER)]:
			app.SetCHEONMA(0)
...
LoadLanguageLocaleFile("locale_game.txt", locals())
...
if 949 == app.GetDefaultCodePage():
	...
	def DO_YOU_BUY_ITEM_IN_MULTISHOP(buyItemName, buyItemCount, buyItemPrice, buyItemCurrency) :
		if buyItemCount > 1 :
			return DO_YOU_BUY_ITEM_MULTISHOP2 % ( buyItemName, buyItemCount, buyItemPrice, buyItemCurrency )
		else:
			return DO_YOU_BUY_ITEM_MULTISHOP1 % ( buyItemName, buyItemPrice, buyItemCurrency )
