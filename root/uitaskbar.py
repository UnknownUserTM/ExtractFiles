...
class PlayerFrame(ui.ScriptWindow):
	...
	def OnUpdate(self):
		...
		if self.playerFrameBoard.IsIn():
			...
			self.playerStatisticToolTip.AppendStatisticTextLine(localeInfo.PLAYER_STATISTIC_GOLD,settinginfo.PLAYER_STATISTIC_DICT[settinginfo.GOLD_EARNED])
			self.playerStatisticToolTip.AppendStatisticTextLine(localeInfo.PLAYER_STATISTIC_AP,settinginfo.PLAYER_STATISTIC_DICT[settinginfo.AP_EARNED])
			self.playerStatisticToolTip.AppendStatisticTextLine(localeInfo.PLAYER_STATISTIC_METIN,settinginfo.PLAYER_STATISTIC_DICT[settinginfo.STONE_KILL_TEMP])
			self.playerStatisticToolTip.AppendStatisticTextLine(localeInfo.PLAYER_STATISTIC_MONSTER,settinginfo.PLAYER_STATISTIC_DICT[settinginfo.MONSTER_KILL_TEMP])
			...
			self.playerStatisticToolTip.AppendStatisticTextLine(localeInfo.PLAYER_STATISTIC_DUELL_COMP,settinginfo.PLAYER_STATISTIC_DICT[settinginfo.PVP_DUELL])
			self.playerStatisticToolTip.AppendStatisticTextLine(localeInfo.PLAYER_STATISTIC_DUELL_WON,settinginfo.PLAYER_STATISTIC_DICT[settinginfo.PVP_DUELL_WON])
			self.playerStatisticToolTip.AppendStatisticTextLine(localeInfo.PLAYER_STATISTIC_DUELL_LOST,settinginfo.PLAYER_STATISTIC_DICT[settinginfo.PVP_DUELL_LOST])
			self.playerStatisticToolTip.AppendStatisticTextLine(localeInfo.PLAYER_STATISTIC_DUELL_SHINSOO_KILL,settinginfo.PLAYER_STATISTIC_DICT[settinginfo.PVP_SHINSOO_KILL])
			self.playerStatisticToolTip.AppendStatisticTextLine(localeInfo.PLAYER_STATISTIC_DUELL_CHUNJO_KILL,settinginfo.PLAYER_STATISTIC_DICT[settinginfo.PVP_CHUNJO_KILL])
			self.playerStatisticToolTip.AppendStatisticTextLine(localeInfo.PLAYER_STATISTIC_DUELL_JINNO_KILL,settinginfo.PLAYER_STATISTIC_DICT[settinginfo.PVP_JINNO_KILL])
			self.playerStatisticToolTip.AppendSpace(5)
			self.playerStatisticToolTip.AppendHorizontalLine()
