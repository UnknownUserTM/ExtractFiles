...
class DragonSoulWindow(ui.ScriptWindow):
	...
	def RefreshEquipSlotWindow(self):
		for i in xrange(6):
			slotNumber = self.__InventoryLocalSlotPosToGlobalSlotPos(fgGHGjjFHJghjfFG1545gGG.INVENTORY, fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_EQUIPMENT_SLOT_START + i)
			itemVnum = fgGHGjjFHJghjfFG1545gGG.GetItemIndex(slotNumber)
			self.wndEquip.SetItemSlot(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_EQUIPMENT_SLOT_START + i, itemVnum, 0)
			self.wndEquip.EnableSlot(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_EQUIPMENT_SLOT_START + i)
			...
			if itemVnum != 0:
				...
				for j in xrange(item.LIMIT_MAX_NUM):
					...
					if item.LIMIT_REAL_TIME == limitType:
						remain_time = fgGHGjjFHJghjfFG1545gGG.GetItemMetinSocket(fgGHGjjFHJghjfFG1545gGG.INVENTORY, slotNumber, 0) - app.GetGlobalTimeStamp()
					elif item.LIMIT_REAL_TIME_START_FIRST_USE == limitType:
						remain_time = fgGHGjjFHJghjfFG1545gGG.GetItemMetinSocket(fgGHGjjFHJghjfFG1545gGG.INVENTORY, slotNumber, 0) - app.GetGlobalTimeStamp()
					elif item.LIMIT_TIMER_BASED_ON_WEAR == limitType:
						remain_time = fgGHGjjFHJghjfFG1545gGG.GetItemMetinSocket(fgGHGjjFHJghjfFG1545gGG.INVENTORY, slotNumber, 0)
						
					if remain_time <= 0:
						self.wndEquip.DisableSlot(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_EQUIPMENT_SLOT_START + i)
						break
	...
	def __InventoryLocalSlotPosToGlobalSlotPos(self, window_type, local_slot_pos):
		if fgGHGjjFHJghjfFG1545gGG.INVENTORY == window_type:
			return self.deckPageIndex * fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_EQUIPMENT_FIRST_SIZE + local_slot_pos
			
		return (self.DSKindIndex * 5 * fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_PAGE_SIZE) + self.inventoryPageIndex * fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_PAGE_SIZE + local_slot_pos
		
	def RefreshBagSlotWindow(self):
		getItemVNum=fgGHGjjFHJghjfFG1545gGG.GetItemIndex
		getItemCount=fgGHGjjFHJghjfFG1545gGG.GetItemCount
		setItemVnum=self.wndItem.SetItemSlot
		for i in xrange(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_PAGE_SIZE):
			self.wndItem.EnableSlot(i)
			#<- dragon soul kind
			slotNumber = self.__InventoryLocalSlotPosToGlobalSlotPos(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, i)

			itemCount = getItemCount(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, slotNumber)
			if 0 == itemCount:
				self.wndItem.ClearSlot(i)
				continue
			elif 1 == itemCount:
				itemCount = 0
			itemVnum = getItemVNum(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, slotNumber)
			...
			if itemVnum != 0:
				...
				for j in xrange(item.LIMIT_MAX_NUM):
					...
					remain_time = 999
					if item.LIMIT_REAL_TIME == limitType:
						remain_time = fgGHGjjFHJghjfFG1545gGG.GetItemMetinSocket(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, slotNumber, 0)
					elif item.LIMIT_REAL_TIME_START_FIRST_USE == limitType:
						remain_time = fgGHGjjFHJghjfFG1545gGG.GetItemMetinSocket(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, slotNumber, 0)
					elif item.LIMIT_TIMER_BASED_ON_WEAR == limitType:
						remain_time = fgGHGjjFHJghjfFG1545gGG.GetItemMetinSocket(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, slotNumber, 0)
	...
	def ShowToolTip(self, window_type, slotIndex):
		if None != self.tooltipItem:
			if fgGHGjjFHJghjfFG1545gGG.INVENTORY == window_type:
				...
				self.tooltipItem.SetInventoryItem(slotIndex, fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY)
	...
	def OverInItem(self, overSlotPos):
		...
		overSlotPos = self.__InventoryLocalSlotPosToGlobalSlotPos(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, overSlotPos)
		try:
		...
		self.wndItem.SetUsableItem(False)
		self.ShowToolTip(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, overSlotPos)
	
	def __UseItem(self, slotIndex):
		ItemVNum = fgGHGjjFHJghjfFG1545gGG.GetItemIndex(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, slotIndex)
		if 0 == fgGHGjjFHJghjfFG1545gGG.GetItemMetinSocket(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, slotIndex, 0):
	...
	def __EquipItem(self, slotIndex):	
		...
		equipSlotPos = fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_EQUIPMENT_SLOT_START + self.deckPageIndex * fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_EQUIPMENT_FIRST_SIZE + subType
		srcItemPos = (fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, slotIndex)
		dstItemPos = (fgGHGjjFHJghjfFG1545gGG.INVENTORY, equipSlotPos)
	...
	def SelectItemSlot(self, itemSlotIndex):
		...
		itemSlotIndex = self.__InventoryLocalSlotPosToGlobalSlotPos(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, itemSlotIndex)
		...
		if mouseModule.mouseController.isAttached():
			...
			if fgGHGjjFHJghjfFG1545gGG.RESERVED_WINDOW != attachedInvenType:
				GFHhg54GHGhh45GHGH.SendItemUseToItemPacket(attachedInvenType, attachedSlotPos, fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, itemSlotIndex)
			...
			if app.SELL == curCursorNum:
				...
				selectedItemVNum = fgGHGjjFHJghjfFG1545gGG.GetItemIndex(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, itemSlotIndex)
				itemCount = fgGHGjjFHJghjfFG1545gGG.GetItemCount(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, itemSlotIndex)
				mouseModule.mouseController.AttachObject(self, fgGHGjjFHJghjfFG1545gGG.SLOT_TYPE_DRAGON_SOUL_INVENTORY, itemSlotIndex, selectedItemVNum, itemCount)
	...
	def __SellItem(self, itemSlotPos):
		if not fgGHGjjFHJghjfFG1545gGG.IsDSEquipmentSlot(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, itemSlotPos):
			self.sellingSlotNumber = itemSlotPos
			itemIndex = fgGHGjjFHJghjfFG1545gGG.GetItemIndex(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, itemSlotPos)
			itemCount = fgGHGjjFHJghjfFG1545gGG.GetItemCount(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, itemSlotPos)
	...
	def SellItem(self):
		...
		GFHhg54GHGhh45GHGH.SendShopSellPacketNew(self.sellingSlotNumber, self.questionDialog.count, fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY)
	...
	def SelectEmptySlot(self, selectedSlotPos):
		...
		selectedSlotPos = self.__InventoryLocalSlotPosToGlobalSlotPos(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, selectedSlotPos)
		if mouseModule.mouseController.isAttached():
			...
			attachedInvenType = fgGHGjjFHJghjfFG1545gGG.SlotTypeToInvenType(attachedSlotType)
			if fgGHGjjFHJghjfFG1545gGG.SLOT_TYPE_PRIVATE_SHOP == attachedSlotType:
				...
				if fgGHGjjFHJghjfFG1545gGG.ITEM_MONEY == attachedItemIndex:
					...
					GFHhg54GHGhh45GHGH.SendSafeboxCheckoutPacket(attachedSlotPos, fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, selectedSlotPos)

			elif fgGHGjjFHJghjfFG1545gGG.SLOT_TYPE_MALL == attachedSlotType:
				GFHhg54GHGhh45GHGH.SendMallCheckoutPacket(attachedSlotPos, fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, selectedSlotPos)

			elif fgGHGjjFHJghjfFG1545gGG.RESERVED_WINDOW != attachedInvenType:
				if fgGHGjjFHJghjfFG1545gGG.IsDSEquipmentSlot(attachedInvenType, attachedSlotPos):
					srcItemPos = (attachedInvenType, attachedSlotPos)
					dstItemPos = (fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, selectedSlotPos)
					self.__OpenQuestionDialog(False, srcItemPos, dstItemPos)
				else:
					itemCount = fgGHGjjFHJghjfFG1545gGG.GetItemCount(attachedInvenType, attachedSlotPos)
					attachedCount = mouseModule.mouseController.GetAttachedItemCount()
 
					self.__SendMoveItemPacket(attachedInvenType, attachedSlotPos, fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, selectedSlotPos, attachedCount)
	...
	def UseItemSlot(self, slotIndex):
		if constInfo.GET_ITEM_QUESTION_DIALOG_STATUS():
			return
		slotIndex = self.__InventoryLocalSlotPosToGlobalSlotPos(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, slotIndex)
		try:
			...
			if self.wndDragonSoulRefine.IsShow():
				if uiPrivateShopBuilder.IsBuildingPrivateShop():
					...
					return
				self.wndDragonSoulRefine.AutoSetItem((fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, slotIndex), 1)
				return
		except:
			pass
	...
	def __SendMoveItemPacket(self, srcSlotWindow, srcSlotPos, dstSlotWindow, dstSlotPos, srcItemCount):
		...
		GFHhg54GHGhh45GHGH.SendItemMovePacket(srcSlotWindow , srcSlotPos, dstSlotWindow, dstSlotPos, srcItemCount)
	...
	def OverInEquipItem(self, overSlotPos):
		overSlotPos = self.__InventoryLocalSlotPosToGlobalSlotPos(fgGHGjjFHJghjfFG1545gGG.INVENTORY, overSlotPos)
		self.wndItem.SetUsableItem(False)
		self.ShowToolTip(fgGHGjjFHJghjfFG1545gGG.INVENTORY, overSlotPos)
	
	def UseEquipItemSlot(self, slotIndex):
		if constInfo.GET_ITEM_QUESTION_DIALOG_STATUS():
			return

		slotIndex = self.__InventoryLocalSlotPosToGlobalSlotPos(fgGHGjjFHJghjfFG1545gGG.INVENTORY, slotIndex)
	...
	def __UseEquipItem(self, slotIndex):
		...
		self.__OpenQuestionDialog(False, (fgGHGjjFHJghjfFG1545gGG.INVENTORY, slotIndex), (1, 1))
	...
	def SelectEquipItemSlot(self, itemSlotIndex):
		...
		itemSlotIndex = self.__InventoryLocalSlotPosToGlobalSlotPos(fgGHGjjFHJghjfFG1545gGG.INVENTORY, itemSlotIndex)

		if mouseModule.mouseController.isAttached():
			attachedSlotType = mouseModule.mouseController.GetAttachedType()
			attachedSlotPos = mouseModule.mouseController.GetAttachedSlotNumber()
			# 자기 자신을 자기 자신에게 드래그하는 경우
			if fgGHGjjFHJghjfFG1545gGG.SLOT_TYPE_INVENTORY == attachedSlotType and itemSlotIndex == attachedSlotPos:
				return
			...
			attachedInvenType = fgGHGjjFHJghjfFG1545gGG.SlotTypeToInvenType(attachedSlotType)
			if fgGHGjjFHJghjfFG1545gGG.RESERVED_WINDOW != attachedInvenType:
				GFHhg54GHGhh45GHGH.SendItemUseToItemPacket(attachedInvenType, attachedSlotPos, fgGHGjjFHJghjfFG1545gGG.INVENTORY, itemSlotIndex)

			mouseModule.mouseController.DeattachObject()
		else:
			selectedItemVNum = fgGHGjjFHJghjfFG1545gGG.GetItemIndex(fgGHGjjFHJghjfFG1545gGG.INVENTORY, itemSlotIndex)
			itemCount = fgGHGjjFHJghjfFG1545gGG.GetItemCount(fgGHGjjFHJghjfFG1545gGG.INVENTORY, itemSlotIndex)
	...
	def SelectEmptyEquipSlot(self, selectedSlot):
		...
		selectedSlotPos = self.__InventoryLocalSlotPosToGlobalSlotPos(fgGHGjjFHJghjfFG1545gGG.INVENTORY, selectedSlot)
		...
		if mouseModule.mouseController.isAttached():
			...
			if fgGHGjjFHJghjfFG1545gGG.SLOT_TYPE_DRAGON_SOUL_INVENTORY == attachedSlotType:
				if 0 == fgGHGjjFHJghjfFG1545gGG.GetItemMetinSocket(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, attachedSlotPos, 0):
					self.wndPopupDialog.SetText(localeInfo.DRAGON_SOUL_EXPIRED)
					self.wndPopupDialog.Open()
					return
				...
				subType = item.GetItemSubType()
				if subType != (selectedSlot - fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_EQUIPMENT_SLOT_START):
					self.wndPopupDialog.SetText(localeInfo.DRAGON_SOUL_UNMATCHED_SLOT)
					self.wndPopupDialog.Open()
				else:
					srcItemPos = (fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY, attachedSlotPos)
					dstItemPos = (fgGHGjjFHJghjfFG1545gGG.INVENTORY, selectedSlotPos)
					self.__OpenQuestionDialog(True, srcItemPos, dstItemPos)
	...
	def __Accept(self):
		if (-1, -1) == self.dstItemPos:
			GFHhg54GHGhh45GHGH.SendItemUsePacket(*self.srcItemPos)
		else:
	...
	def SetDeckPage(self, page):
		...
		if self.isActivated:
			...
			GFHhg54GHGhh45GHGH.SendChatPacket("/dragon_soul deactivate")
	...
	def ActivateButtonClick(self):
		...
		if self.isActivated:
			if self.__CanActivateDeck():
				GFHhg54GHGhh45GHGH.SendChatPacket("/dragon_soul activate " + str(self.deckPageIndex))
			else:
				self.isActivated = False
				self.activateButton.SetUp()
		else:
...
class DragonSoulRefineWindow(ui.ScriptWindow):
	...
	DS_SUB_HEADER_DIC = {
		REFINE_TYPE_GRADE : fgGHGjjFHJghjfFG1545gGG.DS_SUB_HEADER_DO_UPGRADE,
		REFINE_TYPE_STEP : fgGHGjjFHJghjfFG1545gGG.DS_SUB_HEADER_DO_IMPROVEMENT,
		REFINE_TYPE_STRENGTH : fgGHGjjFHJghjfFG1545gGG.DS_SUB_HEADER_DO_REFINE 
	}
	...
	def Close(self):
		...
		fgGHGjjFHJghjfFG1545gGG.SendDragonSoulRefine(fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_REFINE_CLOSE)
		self.Hide()
	...
	def __FlushRefineItemSlot(self):
		...
		for invenType, invenPos, itemCount in self.refineItemInfo.values():
			remainCount = fgGHGjjFHJghjfFG1545gGG.GetItemCount(invenType, invenPos)
			fgGHGjjFHJghjfFG1545gGG.SetItemCount(invenType, invenPos, remainCount + itemCount)
		self.__Initialize()
	...
	def __SetItem(self, inven, dstSlotIndex, itemCount):
		...
		maxCount = fgGHGjjFHJghjfFG1545gGG.GetItemCount(invenType, invenPos)
		...
		fgGHGjjFHJghjfFG1545gGG.SetItemCount(invenType, invenPos, maxCount - itemCount)
	...
	def __SelectRefineEmptySlot(self, selectedSlotPos):
		try:
			...
			if mouseModule.mouseController.isAttached():
				...
				if fgGHGjjFHJghjfFG1545gGG.INVENTORY == attachedInvenType and fgGHGjjFHJghjfFG1545gGG.IsEquipmentSlot(attachedSlotPos):
					return

				if fgGHGjjFHJghjfFG1545gGG.INVENTORY != attachedInvenType and fgGHGjjFHJghjfFG1545gGG.DRAGON_SOUL_INVENTORY != attachedInvenType:
					return
	...
	def __SelectRefineItemSlot(self, selectedSlotPos):
		...
		try:
			...
			selectedItemVnum = fgGHGjjFHJghjfFG1545gGG.GetItemIndex(attachedInvenType, attachedSlotPos)
	...
	def __PressDoRefineButton(self):
		...
		fgGHGjjFHJghjfFG1545gGG.SendDragonSoulRefine(DragonSoulRefineWindow.DS_SUB_HEADER_DIC[self.currentRefineType], self.refineItemInfo)
			...
			for slotPos in xrange(self.wndRefineSlot.GetSlotCount()):
				...
				if slotPos < self.refineSlotLockStartIndex:
					...
					if slotPos in self.refineItemInfo:
						...
						# if itemVnum:
						if itemVnum:
							self.wndRefineSlot.SetItemSlot(slotPos, fgGHGjjFHJghjfFG1545gGG.GetItemIndex(invenType, invenPos), itemCount)
						else:
	...
	def RefineSucceed(self, inven_type, inven_pos):
		...
		itemCount = fgGHGjjFHJghjfFG1545gGG.GetItemCount(inven_type, inven_pos)
		if itemCount > 0:
			self.resultItemInfo[0] = (inven_type, inven_pos, itemCount)
			self.wndResultSlot.SetItemSlot(0, fgGHGjjFHJghjfFG1545gGG.GetItemIndex(inven_type, inven_pos), itemCount)
	
	def	RefineFail(self, reason, inven_type, inven_pos):
		if GFHhg54GHGhh45GHGH.DS_SUB_HEADER_REFINE_FAIL == reason:
			self.__Initialize()
			self.Refresh()
			itemCount = fgGHGjjFHJghjfFG1545gGG.GetItemCount(inven_type, inven_pos)
			if itemCount > 0:
