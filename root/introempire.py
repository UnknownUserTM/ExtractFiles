...
class SelectEmpireWindow(ui.ScriptWindow):
	...
	EMPIRE_DESCRIPTION_TEXT_FILE_NAME = {	
		GFHhg54GHGhh45GHGH.EMPIRE_A : uiScriptLocale.EMPIREDESC_A,
		GFHhg54GHGhh45GHGH.EMPIRE_B : uiScriptLocale.EMPIREDESC_B,
		GFHhg54GHGhh45GHGH.EMPIRE_C : uiScriptLocale.EMPIREDESC_C, }
	...
	def __init__(self, stream):
		...
		GFHhg54GHGhh45GHGH.SetPhaseWindow(GFHhg54GHGhh45GHGH.PHASE_WINDOW_EMPIRE, self)
		...
		self.empireAreaCurAlpha = { GFHhg54GHGhh45GHGH.EMPIRE_A:0.0, GFHhg54GHGhh45GHGH.EMPIRE_B:0.0, GFHhg54GHGhh45GHGH.EMPIRE_C:0.0 }
		self.empireAreaDestAlpha = { GFHhg54GHGhh45GHGH.EMPIRE_A:0.0, GFHhg54GHGhh45GHGH.EMPIRE_B:0.0, GFHhg54GHGhh45GHGH.EMPIRE_C:0.0 }
		self.empireAreaFlagCurAlpha = { GFHhg54GHGhh45GHGH.EMPIRE_A:0.0, GFHhg54GHGhh45GHGH.EMPIRE_B:0.0, GFHhg54GHGhh45GHGH.EMPIRE_C:0.0 }
		self.empireAreaFlagDestAlpha = { GFHhg54GHGhh45GHGH.EMPIRE_A:0.0, GFHhg54GHGhh45GHGH.EMPIRE_B:0.0, GFHhg54GHGhh45GHGH.EMPIRE_C:0.0 }
		self.empireFlagCurAlpha = { GFHhg54GHGhh45GHGH.EMPIRE_A:0.0, GFHhg54GHGhh45GHGH.EMPIRE_B:0.0, GFHhg54GHGhh45GHGH.EMPIRE_C:0.0 }
		self.empireFlagDestAlpha = { GFHhg54GHGhh45GHGH.EMPIRE_A:0.0, GFHhg54GHGhh45GHGH.EMPIRE_B:0.0, GFHhg54GHGhh45GHGH.EMPIRE_C:0.0 }

	def __del__(self):
		ui.ScriptWindow.__del__(self)
		GFHhg54GHGhh45GHGH.SetPhaseWindow(GFHhg54GHGhh45GHGH.PHASE_WINDOW_EMPIRE, 0)
	...
	def __LoadScript(self, fileName):
		...
		try:
			...
			self.empireArea[GFHhg54GHGhh45GHGH.EMPIRE_A]	= GetObject("EmpireArea_A")
			self.empireArea[GFHhg54GHGhh45GHGH.EMPIRE_B]	= GetObject("EmpireArea_B")
			self.empireArea[GFHhg54GHGhh45GHGH.EMPIRE_C]	= GetObject("EmpireArea_C")
			self.empireAreaFlag[GFHhg54GHGhh45GHGH.EMPIRE_A]	= GetObject("EmpireAreaFlag_A")
			self.empireAreaFlag[GFHhg54GHGhh45GHGH.EMPIRE_B]	= GetObject("EmpireAreaFlag_B")
			self.empireAreaFlag[GFHhg54GHGhh45GHGH.EMPIRE_C]	= GetObject("EmpireAreaFlag_C")
			self.empireFlag[GFHhg54GHGhh45GHGH.EMPIRE_A]	= GetObject("EmpireFlag_A")
			self.empireFlag[GFHhg54GHGhh45GHGH.EMPIRE_B]	= GetObject("EmpireFlag_B")
			self.empireFlag[GFHhg54GHGhh45GHGH.EMPIRE_C]	= GetObject("EmpireFlag_C")
	...
	def ClickSelectButton(self):
		GFHhg54GHGhh45GHGH.SendSelectEmpirePacket(self.empireID)
