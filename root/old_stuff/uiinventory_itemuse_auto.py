...
class InventoryWindow(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		try:
			...
			self.DropDownButton2 = self.GetChild("DropDownButton2") # Gildelager
			self.DropDownButton3 = self.GetChild("DropDownButton3") # FB-Lager
			self.DropDownButton4 = self.GetChild("DropDownButton4") # UppItem-Lager
	...
	def RefreshBagSlotWindow(self):
		#chat.AppendChat(chat.CHAT_TYPE_INFO, "RefreshBagSlotWindow")		
		getItemVNum=fgGHGjjFHJghjfFG1545gGG.GetItemIndex
		getItemCount=fgGHGjjFHJghjfFG1545gGG.GetItemCount
		setItemVNum=self.wndItem.SetItemSlot
		settinginfo.WTauGlobalPos = 10000
		for i in xrange(fgGHGjjFHJghjfFG1545gGG.INVENTORY_PAGE_SIZE):
			...
			if itemVnum == settinginfo.WTauNextVnum:
				if settinginfo.WTauGlobalPos == 10000:
					settinginfo.WTauGlobalPos = slotNumber
					chat.AppendChat(chat.CHAT_TYPE_INFO, "slotNumber " + str(slotNumber))	
